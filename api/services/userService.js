...
//returns true if node is successfully updated --- false if it is not found
  updateUser: function(userId, updateData, callback){
    ...
    var user = this.fetchUserById(userId)
    .then(function(node){
...
// module.exports.fetchUserById(542).then(function(node){console.log(node);});
// module.exports.updateUser(45, {name:"harish"}); //.then(function(node){console.log(node);});
